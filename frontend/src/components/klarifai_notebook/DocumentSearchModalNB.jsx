...
const DocumentSearchModalNB = ({ 
  ...
  const searchByContent = async () => {
    ...
    try {
      setIsSearching(true);
      const response = await documentServiceNB.searchDocumentContent({
        query: searchTerm,
...
DocumentSearchModalNB.propTypes = {
...
export default DocumentSearchModalNB;