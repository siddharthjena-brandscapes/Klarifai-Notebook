    ...
    >
      ...
      <div className="flex items-center space-x-4 pb-4 border-b border-[#e3d5c8] dark:border-gray-700">
        ...
        <div className="flex-1">
          <h3 className="text-[#0a3b25] dark:text-white text-lg font-medium">
            {username}
          </h3>
          <p className="text-[#5a544a] dark:text-gray-300 text-sm truncate">
            {userDetails.email}
          </p>
          <button
            onClick={handleImageClick}
...
<Tooltip.Portal>
  ...
  >
    ...
    <Tooltip.Arrow className="fill-[#f7c873] dark:fill-[#2563eb]" />
          ...
          >
            <RefreshCw
              className={`w-4 h-4 text-[#a55233] dark:text-blue-400 ${
