...
const ProfileDropdown = ({
    ...
    try {
      ...
      if (response.data) {
        ...
        try {
          ...
          tokenLimit = matchedUser?.token_limit || matchedUser?.api_tokens?.token_limit || 0;
          pageLimit = matchedUser?.api_tokens?.page_limit || matchedUser?.page_limit || 0;
        } catch (error) {
  ...
  }, [onUserDetailsUpdate]); // Add onUserDetailsUpdate as dependency
