...
<div className="w-full fixed-bottom-0 z-20 pointer-events-none">
  ...
  <div className="flex items-center gap-2 w-full">
      ...
      <div className="flex items-center space-x-2 pr-3">
        ...
        {!message && (
          <button
            ...
            className={`text-gray-400 transition-colors p-1.5 rounded-full ${
    ...
    <button
      onClick={() => handleSendMessage(message)}
      disabled={isLoading}
      className="bg-gradient-to-r from-blue-600/90 to-emerald-600/80 hover:from-blue-500/80 hover:to-emerald-500/70 text-white p-3 rounded-xl transition-all disabled:opacity-50"
      title="Send message"
    >
