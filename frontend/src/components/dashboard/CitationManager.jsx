...
//   // Check if this is a pre-formatted table by counting pipe characters
//   const pipeCount = (content.match(/\|/g) || []).length;
  
//   // Simple check - if it has pipes and dashes, it's probably a table
//   const hasTableStructure = 
//     pipeCount > 6 && // At least some pipes
//     (content.includes('--') || content.includes('==')) // And some kind of separator
...
// /**
//  * Process content with tables and convert to properly formatted HTML tables
//  */
// const formatTableContent = (content) => {
//   try {
//     // First identify all the table sections in the content
//     const sections = [];
//     let currentSection = "";
//     let inTable = false;
...
//     // Process each line to identify tables and other content
...
//           currentSection = line + '\n';
//         } else {
//           // Continue adding to the current table section
//           currentSection += line + '\n';
//         }
        
//         // If this is a separator row, mark the table as having a header
//         if (isSeparator && sections.length > 0 && sections[sections.length - 1].type === 'table') {
//           sections[sections.length - 1].hasHeader = true;
//         }
//       } else {
...
// /**
//  * Component to display formatted text (non-table content)
//  */
// const FormattedText = ({ content }) => {
//   // Format markdown headers and other text elements
...
//   // Format up/down arrows
//   formattedContent = formattedContent.replace(/↑|▲|🔼/g, '<span style="color: #4CAF50;">↑</span>');
//   formattedContent = formattedContent.replace(/↓|▼|🔻/g, '<span style="color: #F44336;">↓</span>');
  
//   // Format footnotes and metadata
//   formattedContent = formattedContent.replace(
//     /(Base:.*?$|T2B\s+Scores:.*?$|©.*?$)/gm,
//     '<span style="color: #a0aec0; font-style: italic;">$1</span>'
//   );
...
// // Update the ParsedTable component with better color contrast
...
//   // If no separator row found, try to use the first row as header
//   if (separatorRowIndex === -1 && lines.length > 0) {
//     headerRow = lines[0];
//     separatorRowIndex = 0;
//   }
...
//   // Format cell content including arrows or special characters
//   const formatCellContent = (content) => {
//     if (!content) return '';
    
//     // Format arrow indicators
...
// /**
//  * This function calculates the appropriate tooltip width based on table complexity
//  */
