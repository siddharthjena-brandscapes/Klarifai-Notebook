...
//   className="
//     text-[#d6292c] font-semibold text-white
//     bg-gradient-to-r from-[#2c3e95]/90 to-[#3fa88e]/80 p-2 rounded-lg flex items-center 
//     justify-center w-full
//     hover:bg-gray-100 hover:shadow-md 
//     transition-all duration-300
//     active:scale-95 space-x-2
...
//   <Lightbulb 
//     size={16} 
//     className={`${selectedDocuments && selectedDocuments.length > 0 ? 'text-yellow-300' : 'text-gray-400'}
//       ${isGenerateIdeasAnimating ? 'animate-pulse' : ''}
//     `} 
//   />
...
//   {/* Documents Header - Restructured */}
//   <div className="flex items-center justify-between mb-1 bg-gradient-to-r from-gray-800/30 to-transparent p-1 rounded-lg">
//     <span className="text-white font-semibold text-xs uppercase tracking-wider">
//       Documents
//     </span>
...
//       <button 
//         onClick={() => setShowDocumentSearch(!showDocumentSearch)}
//         className="p-1 text-gray-300 hover:text-white transition-colors rounded-lg hover:bg-gray-700/30"
//         title='Search Documents'
//       >
//         <Search size={14} />
//       </button>
...
//       {isLoading && isInitialLoad ? (
//         <div className="text-gray-400 text-center py-2 flex items-center justify-center">
//           <div className="flex items-center gap-1">
...
//           {/* Select All Checkbox with Descriptive Text */}
//           {filteredDocuments.length > 0 && (
//             <div className="sticky top-0 z-10 flex items-center p-1 bg-gray-800/30 to-blue-900/20 rounded-lg backdrop-blur-md mb-1">
//               <input
//                 type="checkbox"
//                 id="select-all-documents"
//                 checked={isSelectAllChecked}
...
//     h-4 w-4 
//     accent-[#5ff2b6] 
//     border-2 border-[#5ff2b6]/50 
//     rounded-md 
//     transition-all 
//     hover:border-[#5ff2b6]/80 
...
//             <h6
//               className="
//                 text-white mb-1 flex justify-between 
//                 items-center font-semibold text-xs uppercase 
//                 tracking-wider
//                 bg-gradient-to-r from-gray-800/30 to-transparent 
//                 p-1 rounded-lg
...
//               {/* Chat Filter Dropdown */}
//               {chatFilterMode && (
//                 <div className="absolute right-0 top-full mt-1 w-48 bg-gradient-to-r from-[#2c3e95] to-[#3fa88e] focus:ring-[#5ff2b6]  rounded-lg shadow-lg z-50">
//                   <div className="py-1">
//                     {[
//                       { value: 'recent', label: 'Most Recent', icon: <Calendar size={14} /> },
//                       { value: 'oldest', label: 'Oldest First', icon: <Calendar size={14} /> },
//                       { value: 'mostMessages', label: 'Most Messages', icon: <Tag size={14} /> }
//                     ].map((filter) => (
//                       <button
//                         key={filter.value}
//                         onClick={() => setChatFilterMode(filter.value)}
...
//               <div className="mb-1">
//                 <div className="flex items-center bg-gray-800/30 rounded-lg">
//                   <Search size={14} className="ml-1 text-gray-400" />
//                   <input
//                     type="text"
//                     placeholder="Search chats..."
//                     value={chatSearchTerm}
...
//                   custom-scrollbar pr-1 space-y-1
//                 "
//               >
//                 {filteredChatHistory.length === 0 ? (
//                   <div className="text-gray-400 text-center py-2">
...
//                         >
//                           <div className="flex items-center">
//                             <MessageCircle size={14} className="text-green-400 mr-1" />
//                             <div className="flex flex-col flex-grow overflow-hidden">
//                               <span>{chat.title || 'Untitled Conversation'}</span>
//                               <span className="text-xs text-gray-400">
//                                   {formatRelativeDate(chat.created_at)}
