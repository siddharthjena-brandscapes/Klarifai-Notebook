...
//           dark:hover:bg-blue-800/30 transition-colors
//           focus:outline-none focus:ring-2 dark:focus:ring-blue-700/30
//         "
//       >
//         <div className="flex items-center truncate">
//           {isConsolidatedView ? (
//             <>
//               <Layers className="h-4 w-4 mr-2 dark:text-purple-400" />
//               <span className="truncate dark:text-purple-200">Consolidated View</span>
//             </>
//           ) : (
//             <>
...
//           )}
//         </div>
//         <ChevronDown className="h-4 w-4 ml-2 dark:text-gray-400" />
//       </button>

//       {isOpen && (
//         <div className="
//           absolute z-50 mt-1 w-full
//           dark:bg-gray-800 border dark:border-blue-500/20 rounded-lg
...
//                   flex items-center
//                   ${isConsolidatedView 
//                     ? 'dark:bg-gradient-to-r dark:from-blue-900/70 dark:to-purple-900/70 dark:text-white' 
...
//                   <span className="text-xs dark:text-gray-400">Analyze all documents together</span>
//                 </div>
//               </button>
//             )}
            
//             <div className={selectedDocuments.length > 1 ? "border-t dark:border-gray-700 pt-1 mt-1" : ""}>
...
//                     `}
//                   >
//                     <FileText className="h-4 w-4 mr-2 dark:text-blue-400 flex-shrink-0" />
