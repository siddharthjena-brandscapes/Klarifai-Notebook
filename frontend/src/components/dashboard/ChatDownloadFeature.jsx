...
const ChatDownloadFeature = ({ 
  ...
  return (
    <div className="relative">
      {/* Download Button - Redesigned for Sidebar */}
      <button
        ref={buttonRef}
      ...
      >
        ...
        <span className="text-sm font-medium flex-grow text-left">Export Chats</span>
        {isDownloadMenuOpen ? 
          <ChevronDown size={16} className="text-[#5a544a] dark:text-gray-400" /> : 
          <ChevronUp size={16} className="text-[#5a544a] dark:text-gray-400" />
        }
      </button>
        ...
        <div 
          ...
          <div className="p-3 flex flex-col gap-3">
            ...
            <div className="border border-[#e8ddcc] dark:border-gray-700/50 rounded-lg overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  <FileText size={18} className="text-[#a55233] dark:text-blue-400" />
                  <span className="text-sm text-[#5e4636] dark:text-gray-300">Select Chats</span>
              ...
              {showChatSelection && (
                <div className="p-3 pt-0 border-t border-[#e3d5c8] dark:border-gray-700/50 bg-[#faf4ee]/50 dark:bg-gray-800/20">
                  ...
                  <div className="mb-2 pt-3">
                    ...
                    >
                      {selectedChats.length === chatHistory.length ? 'Deselect All' : 'Select All'}
                    </button>
                  </div>
                      ...
                      <div className="space-y-1">
                        {chatHistory.map(chat => (
                          <div 
                            ...
                            onClick={() => toggleChatSelection(chat.conversation_id)}
                            className={`
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        <Download size={16} />
                        <span>{selectedChats.length === 1 ? 'Download Chat' : 'Download Selected Chats'}</span>
                      </>
                    )}
                  </button>
                </div>
            ...
            <div className="border border-[#e8ddcc] dark:border-gray-700/50 rounded-lg p-3 hover:border-[#a68a70] dark:hover:border-blue-500/50 transition-colors hover:bg-[#f5e6d8]/50 dark:hover:bg-gray-800/30">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-medium text-sm flex items-center gap-2 dark:text-gray-300 text-[#5e4636]">
                  <Calendar size={18} className="text-[#a55233] dark:text-blue-400" />
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                <div>
                  <label className="text-xs text-[#5a544a] dark:text-gray-400 block mb-1">Start</label>
                  <DatePicker
                    selected={startDate}
                ...
                <div>
                  <label className="text-xs text-[#5a544a] dark:text-gray-400 block mb-1">End</label>
                  <DatePicker
                    selected={endDate}
            ...
            <div className="border border-[#e8ddcc] dark:border-gray-700/50 rounded-lg overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2.5">
                  <Settings size={18} className="text-[#a55233] dark:text-blue-400" />
                  <span className="text-sm dark:text-gray-300 text-[#5e4636]">Options</span>
                </div>
                {isCustomizationOpen ? 
                  <ChevronDown size={16} className="text-[#5a544a] dark:text-gray-400" /> : 
                  <ChevronUp size={16} className="text-[#5a544a] dark:text-gray-400" />
                ...
                <div className="p-3 pt-0 border-t border-[#e3d5c8] dark:border-gray-700/50 bg-[#faf4ee]/50 dark:bg-gray-800/20">
                  <div className="space-y-1">
                    <label className="flex items-center gap-2.5 cursor-pointer py-1 hover:bg-[#f5e6d8] dark:hover:bg-gray-700/30 px-2 rounded">
                      ...
                      />
                      <span className="text-sm dark:text-gray-300 text-[#5e4636]">Include Timestamps</span>
                    </label>
                    ...
                    <label className="flex items-center gap-2.5 cursor-pointer py-1 hover:bg-[#f5e6d8] dark:hover:bg-gray-700/30 px-2 rounded">
                      <input
                        ...
                        onChange={() => handleOptionChange("includeChatMetadata")}
                        className="rounded text-[#a55233] dark:text-blue-600 w-4 h-4"
                      />
                      <span className="text-sm dark:text-gray-300 text-[#5e4636]">Include Chat Metadata</span>
                    </label>
                    ...
                    <label className="flex items-center gap-2.5 cursor-pointer py-1 hover:bg-[#f5e6d8] dark:hover:bg-gray-700/30 px-2 rounded">
                      <input
                        ...
                        onChange={() => handleOptionChange("includeFollowUpQuestions")}
                        className="rounded text-[#a55233] dark:text-blue-600 w-4 h-4"
                      />
                      <span className="text-sm dark:text-gray-300 text-[#5e4636]">Include Follow-up Questions</span>
                    </label>
                    ...
                    <label className="flex items-center gap-2.5 cursor-pointer py-1 hover:bg-[#f5e6d8] dark:hover:bg-gray-700/30 px-2 rounded">
                      <input
                        ...
                        className="rounded  text-[#a55233] dark:text-blue-600 w-4 h-4"
                      />
                      <span className="text-sm dark:text-gray-300 text-[#5e4636]">Format Code Blocks</span>
                    </label>
                  </div>
                </div>
              )}
