        ...
        <div className="flex gap-4 pt-4 border-t border-[#e3d5c8] dark:border-gray-700">
          <button
            ...
            className={`flex-1 ${isLoading 
              ? 'bg-gradient-to-r from-[#c28161] to-[#7a8779] cursor-not-allowed' 
              : 'bg-gradient-to-r from-[#a55233] to-[#556052] hover:from-[#8b4513] hover:to-[#425142]'
            } dark:from-blue-500 dark:to-emerald-500 dark:hover:from-blue-600 dark:hover:to-emerald-600 text-white px-6 py-3 rounded-lg flex items-center justify-center gap-2 transition-colors`}
          >
            {isLoading ? (
              <>
          ...
          <button
            onClick={() => setEditingIdea(null)}
            disabled={isLoading}
            className="flex-1 bg-white hover:bg-[#f5e6d8] text-[#5e4636] border border-[#d6cbbf] dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white dark:border-transparent px-6 py-3 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
        </div>
