  ...
  useEffect(() => {
    ...
    if (project) {
      setProjectData({
        ...
        customCategory: categories.includes(project.category)
          ? ""
          : project.category,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const updatedData = {
        ...
        // Include document info if we have a new document or previous document
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (error && error.includes("custom category")) {
                          setError(null);
                        }
                      }}
                      required
