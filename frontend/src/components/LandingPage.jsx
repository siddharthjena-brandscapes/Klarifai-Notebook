...
function App() {
      ...
      try {
        ...
        if (userInfo && userInfo.disabled_modules) {
          const filteredModules = allModules.filter(module => 
            !userInfo.disabled_modules[module.id]
          );
  ...
  if (currentView === "modules" && currentProject) {
    ...
    const allowedModules = currentProject.selected_modules.filter(moduleId => {
          ...
          <div className="max-w-6xl mx-auto">
            ...
            {allowedModules.length === 0 && (
              <div className="col-span-2 text-center py-12 bg-gray-800/50 backdrop-blur-sm rounded-xl border border-emerald-500/20">
                <p className="text-xl text-white mb-4">No available modules</p>
                <p className="text-gray-400">
                  Your access to the modules in this project has been restricted. Please contact an administrator.
                </p>
              </div>
            )}
          </div><div className=" md:grid-cols-3 gap-6">
