  ...
  const renderModuleContent = (moduleId) => {
    ...
    return (
      <div className="relative group">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-emerald-500/20 
          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center space-x-4">
              <div className="p-4 bg-emerald-600/20 rounded-lg group-hover:bg-emerald-600/30 
            ...
            {/* Action button */}
            <button className="px-4 py-2 bg-emerald-600/20 text-emerald-300 rounded-lg 
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <span className="text-xs px-3 py-1 bg-gray-700/50 text-gray-300 rounded-full">
              {module.id === 'document-qa' ? 'Document Q&A' : module.id.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}
            </span>
          </div>
        </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-emerald-900 p-4">
          ...
          <div className="max-w-6xl mx-auto pt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {currentProject.selected_modules
                .map(moduleId => {
                  const module = modules.find(m => m.id === moduleId);
                ...
                <div key={project.id} 
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1 cursor-pointer" onClick={() => handleProjectSelect(project)}>
